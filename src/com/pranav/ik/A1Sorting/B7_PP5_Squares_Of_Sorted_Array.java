 ...
 *
 */
public class B7_PP5_Squares_Of_Sorted_Array {
  ...
  public static void main(String[] args) {
    ...
    int[] result = B7_PP5_Squares_Of_Sorted_Array.sortedSquares(new int[] { -2, -1, 0, 2, 3 });
    for (int num : result)
      System.out.print(num + " ");
    System.out.println();

    result = B7_PP5_Squares_Of_Sorted_Array.sortedSquares(new int[] { -3, -1, 0, 1, 2 });
    for (int num : result)
      System.out.print(num + " ");
    System.out.println();
